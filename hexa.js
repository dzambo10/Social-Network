...
document.querySelector('#deleteProfile').addEventListener('click', e => {
	...
	let text = 'Are you sure that you want to delete the Profile?'
...
document.querySelector('#postForm').addEventListener('submit', e => {
	...
	async function createPost() {
		...
		document.querySelector('#allPostWrapper').innerHTML = `<div class="single-post" data-post_id="${post.id}">
																	...
																	<div class="post-comments">
																		<form>
																			<input placeholder="Write a comment" type="text">
																				<button onclick="comentPostSubmit(event)">Submit</button>
																			</input>
																		</form>
																	</div>
																</div>` + html
